...
from .intents.sailing_weather_intent import get_sailing_weather_intent
...
def on_intent(mycity_request):
    ...
    elif mycity_request.intent_name == "SailingWeatherIntent":
        return get_sailing_weather_intent(mycity_request)
