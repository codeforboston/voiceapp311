...
def main():
    ...
    parser.add_argument(
        ...
        nargs='?',
        const='Env_Var',
        help="Upload your .zip file to Lambda from an S3 bucket. If the S3 " +
             "bucket's name is not specified, attempts to fall back to " +
             "BOSTON_INFO_S3_BUCKET environment variable."
    )
